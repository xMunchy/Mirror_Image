...
function new_level(toggled,dir,back)
  if time()-lvl_dt>1 or game!="game" then
    lvl_dt = time()
    enemy_is_talking = false
    killspeaker = null
    ...
    if not toggled and not dir then
...
function spawn(l)
  if l==0 then --part 1 tutorial
    --spawn enemies
    make_enemy(1,50,16,false,nopath)
    make_enemy(1,110,16,false,nopath)
  elseif l==19 then --part 2 tutorial
    make_enemy(1,48,40,false,nopath)
    make_enemy(2,80,32,false,nopath)
    make_enemy(1,120,24,false,nopath)
  elseif l==1 then
...
function fall()
  ...
  --make enemies fall
  for i=1,#enemy do
   local y2 = enemy[i].y+enemy[i].h
   local x3 = enemy[i].x
   local x4 = enemy[i].x+enemy[i].w-1
   if v_collide(x3,x4,y2-0.5,i) then
    enemy[i].y = flr(enemy[i].y-0.5)
  else
    if(not v_collide(x3,x4,y2,i)) enemy[i].y += 0.5
   end
 end
end
...

...
0404440405555555000044444400400000044444000001114444fff50000ffff05000000060000000505000000000055252525000000000000000000000000f1
...
00011500001114410000555558880000666666660000000000000000555555540500c50000000000151515150000000500000000000000000000002424242424
...
00100100001110110005500000550000001144110000000000000000000015110500c60000000000000000000000000500000000000000343524163524163524
...
__gff__

...

...

...

...

...

